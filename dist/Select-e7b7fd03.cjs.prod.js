...
var React = require("react"), React__default = _interopDefault(React), memoizeOne = _interopDefault(require("memoize-one")), core = require("@emotion/core"), reactDom = require("react-dom"), utils = require("./utils-2db2ca57.cjs.prod.js"), index = require("./index-82777e10.cjs.prod.js"), _css = _interopDefault(require("@emotion/css")), diacritics = [ {
  base: "A",
...
var defaultProps = {
  ...
  return _proto.componentDidMount = function() {
    ...
    }, menuElement = React__default.createElement(index.MenuPlacer, _extends$4({}, commonProps, menuPlacementProps), (function(_ref6) {
    ...
    var _this$state10 = this.state, ariaLiveSelection = _this$state10.ariaLiveSelection, isFocused = _this$state10.isFocused, ariaLiveMessage = this.constructAriaLiveMessage();
    return React__default.createElement(A11yText, {
      "aria-live": "polite",
      "aria-relevant": "additions text",
      "aria-atomic": "true"
    }, isFocused && React__default.createElement(React__default.Fragment, null, React__default.createElement("p", {
      id: "aria-selection-event",
      key: ariaLiveSelection
    }, " ", ariaLiveSelection), React__default.createElement("p", {
      id: "aria-context",
      key: ariaLiveMessage
    }, " ", ariaLiveMessage)));
  }, _proto.render = function() {
